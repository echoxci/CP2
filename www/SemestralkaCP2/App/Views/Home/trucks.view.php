...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row gx-4 gx-lg-5 row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            <?php foreach($data as $trucks): ?>
            <div class="col mb-5">
                <div class="card h-100">
                    <img class="card-img-top" src="public/assets/img/<?= $trucks->img_path ?>" alt="<?= $trucks->name ?>"/>
                    <div class="card-body p-4">
                        <div class="text-center">
                            <h5 class="fw-bolder"><?= $trucks->name ?></h5>
                            <?= $trucks->description ?>
                            <p><?= $trucks->price ?> &euro;</p>
                        </div>
                    </div>
